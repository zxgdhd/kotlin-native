...
class KonanDescriptorSerializer private constructor(
    ...
    fun packagePartProto(packageFqName: FqName, members: Collection<DeclarationDescriptor>): ProtoBuf.Package.Builder {
        ...
        val sinceKotlinInfoTableProto = sinceKotlinInfoTable.serialize()
        if (sinceKotlinInfoTableProto != null) {
            builder.sinceKotlinInfoTable = sinceKotlinInfoTableProto
        }
    ...
    private fun writeSinceKotlinInfo(languageFeature: LanguageFeature): Int {
        ...
        val requirement = ProtoBuf.SinceKotlinInfo.newBuilder().apply {
        ...
        return sinceKotlinInfoTable[requirement]
    }
